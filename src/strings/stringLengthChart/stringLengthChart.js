...
import vid from './stringLengthChart.mp4';
import score from './stringLengthChart.png';
...
const instrumentText = {
  0: "Performer: Makito Nishiya. \n\n" +
    ...
    "You can watch a replica of this page performed on cello at the Cello: Natural Harmonics Page.",
...
export default function MakePage() {
  return (
    <div>
      <Instrument
        instrument="String Length Chart"
        title="Animation"
        vid={vid}
